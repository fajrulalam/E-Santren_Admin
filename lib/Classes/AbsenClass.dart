...
class AbsenClass {
  ...
  List<AbsenObject> getData() {
    dataAbsenSantri = <AbsenObject>[
      ...
      AbsenObject('DU15230002', ' Muhammad Ghinan Navsih', 'Kamar 2', 'Alfa'),
      AbsenObject('DU15230003', 'Muhammad Rekyan', 'Kamar 2', 'Sakit'),
      AbsenObject('DU15230004', 'Bagus Al-Fikri', 'Kamar 5', 'Hadir'),
      AbsenObject('DU15230005', 'Abdul Sholeh', 'Kamar 4', 'Alfa'),
      AbsenObject('DU15230006', 'Ariasatya Mahatma', 'Kamar 3', 'Sakit'),
      AbsenObject(
          'DU15230007', 'Naufal Sirullah Ahmad Sunandar', 'Kamar 1', 'Hadir'),
      AbsenObject('DU15230008', 'Dwiki Cahyo', 'Kamar 3', 'Alfa'),
      AbsenObject('DU15230009', 'Ahmad Giffar', 'Kamar 6', 'Sakit'),
